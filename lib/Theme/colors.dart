...
class ColorPalette {
  static const Color lightPrimary = Color(0xffEDEEF0);
  static const Color lightSecondary = Color(0xffE1E3E6);
  static const Color lightAccent = Color(0xffB1B5B7);

  static const Color primary3 = Color(0xff5D5f64);

  static const Color darkPrimary = Color(0xffE21221);
  static const Color darkBackground = Color.fromRGBO(14, 16, 29, 1);
